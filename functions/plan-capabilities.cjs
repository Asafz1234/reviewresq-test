const PLAN_ORDER = ["starter", "growth", "pro_ai"];
...
function getPlanCapabilities(planId = "starter") {
...
function getPlanEntitlements(planId = "starter") {
...
function hasFeature(planOrSession, feature) {
